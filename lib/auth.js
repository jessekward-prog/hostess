...
function verifyToken(token) {
  ...
  // The cookie's own maxAge is a browser-side instruction only -- without this,
  // a token that leaked (backed-up browser profile, synced cookie store, etc.)
  // would keep authenticating forever, past 90 days, until the password is
  // next changed (which is what actually rotates sessionSecret).
