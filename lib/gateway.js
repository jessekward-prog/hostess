...
// Don't hold the event loop open on this timer's account. The dashboard server
// has its own reason to stay alive; one-shot CLI callers (deploy.js) require
// this module transitively via engine.js and would otherwise finish their work
// and then hang here forever.
syncTimer.unref();
